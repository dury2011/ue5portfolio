...
private:
	...
	EWeaponGunFireSelectorType _CurrentWeaponFireSelectorType;
protected:
// ******************************************************************************************************
// methods
// ******************************************************************************************************
public:
	...
	FORCEINLINE void SetCurrentWeaponFireSelectorType(EWeaponGunFireSelectorType InType) { _CurrentWeaponFireSelectorType = InType; }
	...
	FORCEINLINE EWeaponGunFireSelectorType GetCurrentWeaponFireSelectorType() { return _CurrentWeaponFireSelectorType; }
